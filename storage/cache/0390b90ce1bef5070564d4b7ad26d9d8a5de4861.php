                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="<?php echo e(url('register')); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="user_name" name="user_name" class="form-control <?php if($errors && $errors->has('user_name')): ?> is-invalid <?php endif; ?>" placeholder="user_name" required value="<?php echo e($old?$old['user_name']:''); ?>">
...
<?php echo $__env->make('layouts.front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/short-links/views/front/auth/register.blade.php ENDPATH**/ ?>