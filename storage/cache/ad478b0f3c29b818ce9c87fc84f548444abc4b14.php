...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group has-feedback <?php if($errors && $errors->has('first_name')): ?> has-error <?php endif; ?>">
            ...
            <input type="text" name="first_name" id="first_name" class="form-control" placeholder="Firstname" value="<?php if($old && $old['first_name']): ?><?php echo e($old['first_name']); ?><?php elseif(isset($admin)): ?><?php echo e($admin->first_name); ?><?php endif; ?>">
    ...
    <div class="col-sm-6">
        <div class="form-group has-feedback <?php if($errors && $errors->has('last_name')): ?> has-error <?php endif; ?>">
            ...
            <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Lastname" value="<?php if($old && $old['last_name']): ?><?php echo e($old['last_name']); ?><?php elseif(isset($admin)): ?><?php echo e($admin->last_name); ?><?php endif; ?>">
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group has-feedback <?php if($errors && $errors->has('user_name')): ?> has-error <?php endif; ?>">
            ...
            <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Username" value="<?php if($old && $old['user_name']): ?><?php echo e($old['user_name']); ?><?php elseif(isset($admin)): ?><?php echo e($admin->user_name); ?><?php endif; ?>">
...
</div><?php /**PATH /var/www/short-links/views/layouts/admin/dashboard/partials/form-admin.blade.php ENDPATH**/ ?>