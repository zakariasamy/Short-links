...
<body class="bg-purple">
    ...
    <div class="stars">
        <div class="central-body">
            ...
            <a href="<?php echo e(Phpmng\Http\Request::baseURL()); ?>" class="btn-go-home" target="_blank">GO BACK HOME</a>
        </div>
        <div class="objects">
...
</html><?php /**PATH /var/www/short-links/views/errors/404.blade.php ENDPATH**/ ?>